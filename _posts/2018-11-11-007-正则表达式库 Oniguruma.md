---
layout:     post
title:      007-正则表达式库 Oniguruma
subtitle:    "\"007-正则表达式库 Oniguruma\""
date:       2018-11-09
author:     PZ
...
\[%{WORD:method}\]\[%{WORD:method1}\]\[%{JAVAFILE:method2}\(%{JAVAFILE:class}\:%{NUMBER:line}\)\]\[%{YEAR:yeat}-%{MONTHNUM:y}-%{MONTHDAY:we}[T ]%{HOUR:yt}:?%{MINUTE:23}(?::?%{SECOND:23})\s%{ISO8601_TIMEZONE:hg}?